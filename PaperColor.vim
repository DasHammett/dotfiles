...
fun! s:register_default_theme()
  ...
  "       \     }
  "       \ }
  " color 13: #ff5faf -> numero
  " color 16: #5fafd7-> blau parentesis ?
  " color 14: #00afaf -> turquesa
  " color 03: #d7af5f -> text comentaris
  " folded_gb: #afdf00 -> color text fold tancat
  ...
  let s:themes['default'].dark = {
        ...
        \       'error_fg' : ['#af005f', '125'],
        \       'error_bg' : ['#5f0000', '52'],
        \       'matchparen_bg' : ['#afdf00', '0'],
        \       'matchparen_fg' : ['#262626', '151'],
        \       'visual_fg' : ['#000000', '16'],
        \       'visual_bg' : ['#8787af', '103'],
        \       'folded_fg' : ['#CBCE7B', '177'],
        \       'folded_bg' : ['#444444', '53'],
...
fun! s:set_color_variables()
  ...
  let hammett = get(s:palette, 'hammett')
  ...
  call s:create_color_variables('accent',    color10 , 'LightBlue')
  ...
  call s:create_color_variables('hammett', hammett , 'Hammett')
...
fun! s:apply_syntax_highlightings()
  ...
  exec 'hi rArrow' . s:fg_hammett
  " exec 'hi rDollar' . s:fg_blue
  exec 'hi rDollar' . s:fg_hammett
